...
BOOST_AUTO_TEST_CASE( smt_mh_test )
{
   ...
   try
   {
      ...
      appbase::app().initialize<
         webanpick::plugins::market_history::market_history_plugin,
      ...
      generate_block();
      db->set_hardfork( WEBANPICK_NUM_HARDFORKS );
      generate_block();
      ...
      BOOST_REQUIRE( bucket->webanpick.high == ASSET( "1.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.high == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.low == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.low == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.open == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.open == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.close == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_webanpick.close == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.volume == asset( 750, any_smt_symbol ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->webanpick.high == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.low == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.low == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.open == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.open == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.close == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_webanpick.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.volume == asset( 250, any_smt_symbol ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) + 60 );
      BOOST_REQUIRE( bucket->webanpick.high == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.low == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.low == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.open == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.open == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.close == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->non_webanpick.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.volume == ASSET( "0.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.volume == asset( 500, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->webanpick.close == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->non_webanpick.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.volume == ASSET( "1.450 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.volume == asset( 750, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->open == WEBANPICK_GENESIS_TIME );
      BOOST_REQUIRE( bucket->webanpick.high == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.low == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.low == asset( 750, any_smt_symbol ).amount );
      ...
      BOOST_REQUIRE( bucket->webanpick.close == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->non_webanpick.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->webanpick.volume == ASSET( "2.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_webanpick.volume == asset( 1500, any_smt_symbol ).amount );
      bucket++;
