...
#if defined IS_TEST_NET && defined WEBANPICK_ENABLE_SMT
...
BOOST_AUTO_TEST_CASE( smt_liquidity_rewards )
{
   ...
   try
   {
      ...
      alice_webanpick_volume += ( asset( alice_smt.amount / 20, any_smt_symbol ) * exchange_rate ).amount.value;
      alice_reward_last_update = db->head_block_time();
      bob_webanpick_volume -= ( asset( alice_smt.amount / 20, any_smt_symbol ) * exchange_rate ).amount.value;
      ...
      op.owner = "sam";
      op.amount_to_sell = asset( ( alice_smt.amount.value / 20 ), WEBANPICK_SYMBOL );
      ...
      op.owner = "bob";
      op.orderid = 4;
      op.amount_to_sell = asset( ( alice_smt.amount.value / 10 ) * 3 - alice_smt.amount.value / 20, WEBANPICK_SYMBOL );
      ...
      op.min_to_receive = asset( ( alice_smt.amount.value / 10 ) * 3, WEBANPICK_SYMBOL );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( ( alice_smt.amount.value / 10 ) * 3 - alice_smt.amount.value / 20, WEBANPICK_SYMBOL ).amount.value );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( alice_smt.amount.value / 20, WEBANPICK_SYMBOL ).amount.value );
      BOOST_REQUIRE( fill_order_op.current_owner == "alice" );
      BOOST_REQUIRE( fill_order_op.current_orderid == 5 );
      ...
      op.min_to_receive = asset( alice_smt.amount.value / 20 * 2, WEBANPICK_SYMBOL );
      ...
      BOOST_REQUIRE( fill_order_op.current_pays.amount.value == asset( alice_smt.amount.value / 20, WEBANPICK_SYMBOL ).amount.value );
      ...
      alice_webanpick_volume += alice_smt.amount.value / 20;
      alice_reward_last_update = db->head_block_time();
      sam_webanpick_volume -= alice_smt.amount.value / 20;
      sam_reward_last_update = db->head_block_time();
      ...
      op.owner = "alice";
      op.amount_to_sell = asset( 8 * ( alice_smt.amount.value / 20 ), WEBANPICK_SYMBOL );
