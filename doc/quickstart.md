...
### Get current webanpickd
Use docker:
```
docker run \
    -d -p 2001:2001 -p 8090:8090 --name webanpickd-default \
    --restart unless-stopped webanpickit/webanpick
```
#### Low memory node?
...
docker run \
    ...
    -d -p 2001:2001 -p 8090:8090 --name webanpickd-full \
    --restart unless-stopped \
    webanpickit/webanpick
```
