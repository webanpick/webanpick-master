...
operation_tests      // Unit Tests of Webanpick operations
operation_time_tests // Tests of Webanpick operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_WEBANPICK_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
