...
The Webanpick developers recommend using the first of these methods to secure the API by binding to localhost, as follows:
...
The `webanpickd` process includes username/password based authentication to individual API's.
