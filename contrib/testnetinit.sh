...
WEBANPICKD="/usr/local/webanpickd-testnet/bin/webanpickd"

UTILS="/usr/local/webanpickd-testnet/bin"
...
cp /etc/webanpickd/testnet.config.ini $HOME/config.ini
cp /etc/webanpickd/fastgen.config.ini $HOME/testnet_datadir/config.ini

chown webanpickd:webanpickd $HOME/config.ini
chown webanpickd:webanpickd $HOME/testnet_datadir/config.ini
...
# setup tinman
git clone https://github.com/webanpickit/tinman
cd tinman/tinman
git clone https://github.com/webanpickit/simple_webanpick_client
cd $HOME
...
echo webanpickd-testnet: starting fastgen node
...
echo webanpickd-testnet: pipelining transactions into fastgen node, this may take some time
( \
...
# let's get going
echo webanpickd-testnet: bringing up witness / full node
