...
namespace webanpick { namespace protocol {
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = WEBANPICK_MAX_SIG_CHECK_DEPTH
         )const;
      ...
      void verify_authority(
         ...
         const authority_getter& get_owner,
         const authority_getter& get_posting,
         uint32_t max_recursion = WEBANPICK_MAX_SIG_CHECK_DEPTH )const;
...
FC_REFLECT( webanpick::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( webanpick::protocol::signed_transaction, (webanpick::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( webanpick::protocol::annotated_signed_transaction, (webanpick::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
