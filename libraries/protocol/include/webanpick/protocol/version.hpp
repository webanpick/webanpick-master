...
/*
 * This class represents the basic versioning scheme of the Webanpick blockchain.
...
{
   class variant;
   void to_variant( const webanpick::protocol::version& v, variant& var );
   void from_variant( const variant& var, webanpick::protocol::version& v );

   void to_variant( const webanpick::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, webanpick::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( webanpick::protocol::version, (v_num) )
FC_REFLECT_DERIVED( webanpick::protocol::hardfork_version, (webanpick::protocol::version), )

FC_REFLECT( webanpick::protocol::hardfork_version_vote, (hf_version)(hf_time) )
