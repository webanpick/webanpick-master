...
#include <webanpick/protocol/validation.hpp>
#include <webanpick/protocol/legacy_asset.hpp>
...
namespace webanpick { namespace protocol {
    ...
    *  @see SMT spec for details: https://github.com/webanpickit/smt-whitepaper/blob/master/smt-manual/manual.md
    */
   struct allowed_vote_assets
   {
      ...
      void validate() const
      {
         ...
         FC_ASSERT(is_allowed(WEBANPICK_SYMBOL) == false,
            "WEBANPICK can not be explicitly specified as one of allowed_vote_assets");
      }
    ...
    *  The percent_webanpick_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      uint16_t          percent_webanpick_dollars  = WEBANPICK_100_PERCENT; /// the percent of Webanpick Dollars to key, unkept amounts will be received as Webanpick Power
    ...
    * @ingroup operations
    *
    * @brief Transfers WEBANPICK from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             webanpick_amount = asset( 0, WEBANPICK_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      asset             webanpick_amount = asset( 0, WEBANPICK_SYMBOL ); ///< the amount of webanpick to release
   ...
   /**
    *  This operation converts WEBANPICK into VFS (Vesting Fund Shares) at
   ...
   struct transfer_to_vesting_operation : public base_operation
   {
      ...
      asset             amount; ///< must be WEBANPICK
    ...
    * vests to webanpick and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in WEBANPICK, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      legacy_webanpick_asset account_creation_fee = legacy_webanpick_asset::from_amount( WEBANPICK_MIN_ACCOUNT_CREATION_FEE );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = WEBANPICK_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          sbd_interest_rate  = WEBANPICK_DEFAULT_SBD_INTEREST_RATE;
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= WEBANPICK_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= WEBANPICK_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( sbd_interest_rate >= 0 );
         FC_ASSERT( sbd_interest_rate <= WEBANPICK_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, WEBANPICK_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
    ...
    *  used to define the exchange rate between webanpick and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between WEBANPICK and SBD,
    *  The funds are deposited after WEBANPICK_CONVERSION_DELAY
    */
    ...
    * WEBANPICK_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting webanpick.
    *
    * The result of the operation is to transfer the full VESTING WEBANPICK balance
...
FC_REFLECT( webanpick::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( webanpick::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( webanpick::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( webanpick::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( webanpick::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( webanpick::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( webanpick::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( webanpick::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( webanpick::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( webanpick::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( webanpick::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( webanpick::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( webanpick::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            (sbd_interest_rate)
          )

FC_REFLECT_TYPENAME( webanpick::protocol::pow2_work )
FC_REFLECT( webanpick::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( webanpick::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( webanpick::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( webanpick::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( webanpick::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( webanpick::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( webanpick::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( webanpick::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( webanpick::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( webanpick::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( webanpick::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( webanpick::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( webanpick::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( webanpick::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( webanpick::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( webanpick::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( webanpick::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( webanpick::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( webanpick::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( webanpick::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( webanpick::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( webanpick::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( webanpick::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( webanpick::protocol::comment_payout_beneficiaries, (beneficiaries) )

#ifdef WEBANPICK_ENABLE_SMT
FC_REFLECT( webanpick::protocol::votable_asset_info_v1, (max_accepted_payout)(allow_curation_rewards) )
FC_REFLECT( webanpick::protocol::allowed_vote_assets, (votable_assets) )
#endif

FC_REFLECT_TYPENAME( webanpick::protocol::comment_options_extension )
FC_REFLECT( webanpick::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_webanpick_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( webanpick::protocol::escrow_transfer_operation, (from)(to)(sbd_amount)(webanpick_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( webanpick::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( webanpick::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( webanpick::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(webanpick_amount) );
FC_REFLECT( webanpick::protocol::placeholder_a_operation, );
FC_REFLECT( webanpick::protocol::placeholder_b_operation, );
FC_REFLECT( webanpick::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( webanpick::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( webanpick::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( webanpick::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( webanpick::protocol::claim_reward_balance_operation, (account)(reward_webanpick)(reward_sbd)(reward_vests) )
#ifdef WEBANPICK_ENABLE_SMT
FC_REFLECT( webanpick::protocol::claim_reward_balance2_operation, (account)(extensions)(reward_tokens) )
#endif
FC_REFLECT( webanpick::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
