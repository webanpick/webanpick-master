...
namespace webanpick { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), sbd_payout(s), webanpick_payout(st), vesting_payout(v){}

      account_name_type author;
      string            permlink;
      asset             sbd_payout;
      asset             webanpick_payout;
...
FC_REFLECT( webanpick::protocol::author_reward_operation, (author)(permlink)(sbd_payout)(webanpick_payout)(vesting_payout) )
FC_REFLECT( webanpick::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( webanpick::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( webanpick::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( webanpick::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( webanpick::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( webanpick::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( webanpick::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( webanpick::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( webanpick::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( webanpick::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( webanpick::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( webanpick::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( webanpick::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( webanpick::protocol::producer_reward_operation, (producer)(vesting_shares) )
