 ...
 * - Length is between (inclusive) WEBANPICK_MIN_ACCOUNT_NAME_LENGTH and WEBANPICK_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace webanpick::protocol


FC_REFLECT_TYPENAME( webanpick::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( webanpick::protocol::authority::key_authority_map)
FC_REFLECT( webanpick::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( webanpick::protocol::authority::classification, (owner)(active)(key)(posting) )
