...
//
// Place WEBANPICK_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define WEBANPICK_DEFINE_OPERATION_TYPE( OperationType )                       \
namespace fc {                                                             \
                                                                           \
...
{                                                                          \
   op.visit( webanpick::protocol::operation_validate_visitor() );               \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( webanpick::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* webanpick::protocol */
