...
#include <webanpick/protocol/operation_util.hpp>
#include <webanpick/protocol/webanpick_operations.hpp>
#include <webanpick/protocol/webanpick_virtual_operations.hpp>
...
/*namespace fc {
    void to_variant( const webanpick::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  webanpick::protocol::operation& vo );
}*/

WEBANPICK_DECLARE_OPERATION_TYPE( webanpick::protocol::operation )
FC_REFLECT_TYPENAME( webanpick::protocol::operation )
