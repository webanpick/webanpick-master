...
namespace webanpick { namespace protocol {
    ...
    public_key_type::public_key_type( const std::string& base58str )
    {
      ...
      //        to make public_key_type API more similar to address API
       std::string prefix( WEBANPICK_ADDRESS_PREFIX );
    ...
    public_key_type::operator std::string() const
    {
       ...
       return WEBANPICK_ADDRESS_PREFIX + fc::to_base58( data.data(), data.size() );
    }
...
namespace fc
{
    ...
    {
        vo = webanpick::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = webanpick::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = webanpick::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
