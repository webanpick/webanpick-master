...
using namespace webanpick::utilities;
...
{
   public:
      wallet_api( const wallet_data& initial_data, const webanpick::protocol::chain_id_type& _webanpick_chain_id, fc::api< remote_node_api > rapi );
      virtual ~wallet_api();
       ...
       *  'info' wallet command.
       *
       *  These accounts are created with combination of WEBANPICK and delegated SP
       *
       *  @param creator The account creating the new account
       *  @param webanpick_fee The amount of the fee to be paid with WEBANPICK
       *  @param delegated_vests The amount of the fee to be paid with delegation
       *  @param new_account_name The name of the new account
       *  @param json_meta JSON Metadata associated with the new account
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction create_account_delegated( string creator, asset webanpick_fee, asset delegated_vests, string new_account_name, string json_meta, bool broadcast );
      ...
      /**
       * Transfer funds from one account to another. WEBANPICK and SBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param amount The funds being transferred. i.e. "100.000 WEBANPICK"
      ...
      /**
       * Transfer funds from one account to another using escrow. WEBANPICK and SBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       ...
       * @param webanpick_amount The amount of WEBANPICK to transfer
       ...
       * @param webanpick_amount The amount of WEBANPICK that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       * Transfer WEBANPICK into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of WEBANPICK is vesting.
       *
       * @param from The account the WEBANPICK is coming from
       * @param to The account getting the VESTS
       * @param amount The amount of WEBANPICK to vest i.e. "100.00 WEBANPICK"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *    withdrawn and deposited back as WEBANPICK. i.e. "10.000000 VESTS"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *
       * @param from The account the VESTS are withdrawn from.
       * @param to   The account receiving either VESTS or WEBANPICK.
      ...
      /**
       *  This method will convert SBD to WEBANPICK at the current_median_history price one
      ...
      /**
       * A witness can public a price feed for the WEBANPICK:SBD market. The median price feed is used
       * to process conversion requests from SBD to WEBANPICK.
       *
       ...
       *                       operations defined in `webanpick/chain/operations.hpp`
      ...
      /**
       * Gets the current order book for WEBANPICK:SBD
       *
       ...
       *  @param amount_to_sell The amount of either SBD or WEBANPICK you wish to sell
      ...
      /**
       * Vote on a comment to be paid WEBANPICK
       *
      ...
      annotated_signed_transaction claim_reward_balance( string account, asset reward_webanpick, asset reward_sbd, asset reward_vests, bool broadcast );
};
...
FC_REFLECT( webanpick::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( webanpick::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( webanpick::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( webanpick::wallet::authority_type, (owner)(active)(posting) )

FC_API( webanpick::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( webanpick::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
