...
#include <webanpick/schema/schema.hpp>
   ...
   : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
{
   public:
      ...
      virtual std::shared_ptr< webanpick::schema::abstract_schema > get_operation_schema() override
      {
         return webanpick::schema::get_schema_for_type< CustomOperationType >();
      }
};
