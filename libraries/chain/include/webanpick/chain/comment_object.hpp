...
FC_REFLECT( webanpick::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::comment_object, webanpick::chain::comment_index )

FC_REFLECT( webanpick::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::comment_content_object, webanpick::chain::comment_content_index )

FC_REFLECT( webanpick::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::comment_vote_object, webanpick::chain::comment_vote_index )

namespace helpers
{
   using webanpick::chain::shared_string;
   
   template <>
   class index_statistic_provider<webanpick::chain::comment_index>
   {
   public:
      typedef webanpick::chain::comment_index IndexType;
      typedef typename webanpick::chain::comment_object::t_beneficiaries t_beneficiaries;
   ...
   template <>
   class index_statistic_provider<webanpick::chain::comment_content_index>
   {
   public:
      typedef webanpick::chain::comment_content_index IndexType;
