...
namespace webanpick { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert sbd to webanpick
    */
    ...
    *  1000 WEBANPICK or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         {
            return webanpick_volume * sbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(webanpick_volume,sbd_volume) * is_positive();
         }
         ...
         {
            return ( webanpick_volume > 0 && sbd_volume > 0 ) ? 1 : 0;
         }
   };
...
FC_REFLECT( webanpick::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::limit_order_object, webanpick::chain::limit_order_index )

FC_REFLECT( webanpick::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::feed_history_object, webanpick::chain::feed_history_index )

FC_REFLECT( webanpick::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::convert_request_object, webanpick::chain::convert_request_index )

FC_REFLECT( webanpick::chain::liquidity_reward_balance_object,
             (id)(owner)(webanpick_volume)(sbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::liquidity_reward_balance_object, webanpick::chain::liquidity_reward_balance_index )

FC_REFLECT( webanpick::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::withdraw_vesting_route_object, webanpick::chain::withdraw_vesting_route_index )

FC_REFLECT( webanpick::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::savings_withdraw_object, webanpick::chain::savings_withdraw_index )

FC_REFLECT( webanpick::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (sbd_balance)(webanpick_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::escrow_object, webanpick::chain::escrow_index )

FC_REFLECT( webanpick::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::decline_voting_rights_request_object, webanpick::chain::decline_voting_rights_request_index )

FC_REFLECT( webanpick::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::reward_fund_object, webanpick::chain::reward_fund_index )
