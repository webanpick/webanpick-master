...
FC_REFLECT( webanpick::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::transaction_object, webanpick::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<webanpick::chain::transaction_index>
   {
   public:
      typedef webanpick::chain::transaction_index IndexType;
      typedef typename webanpick::chain::transaction_object::t_packed_trx t_packed_trx;
