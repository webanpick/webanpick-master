...
#include <webanpick/chain/buffer_type.hpp>
...
FC_REFLECT( webanpick::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::operation_object, webanpick::chain::operation_index )

FC_REFLECT( webanpick::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::account_history_object, webanpick::chain::account_history_index )

namespace helpers
{
   template <>
   class index_statistic_provider<webanpick::chain::operation_index>
   {
   public:
      typedef webanpick::chain::operation_index IndexType;
         ...
         if(onlyStaticInfo == false)
         {
            for(const auto& o : index)
               info._item_additional_allocation +=
                  o.serialized_op.capacity()*sizeof(webanpick::chain::buffer_type::value_type);
         }
   ...
   template <>
   class index_statistic_provider<webanpick::chain::account_history_index>
   {
   public:
      typedef webanpick::chain::account_history_index IndexType;
      ...
      index_statistic_info gather_statistics(const IndexType& index, bool onlyStaticInfo) const
      {
         ...
         if(onlyStaticInfo == false)
         {
            ...
            //      sizeof(webanpick::chain::account_history_object::operation_container::value_type);
         }
