...
namespace webanpick { namespace chain {
   ...
   using webanpick::protocol::digest_type;
   using webanpick::protocol::public_key_type;
   using webanpick::protocol::version;
   using webanpick::protocol::hardfork_version;
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( WEBANPICK_MIN_ACCOUNT_CREATION_FEE, WEBANPICK_SYMBOL );
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Webanpick blockchain version the witness is running.
          */
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, WEBANPICK_MAX_WITNESSES >             current_shuffled_witnesses;
...
FC_REFLECT_ENUM( webanpick::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( webanpick::chain::chain_properties,
...
FC_REFLECT( webanpick::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::witness_object, webanpick::chain::witness_index )

FC_REFLECT( webanpick::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::witness_vote_object, webanpick::chain::witness_vote_index )

FC_REFLECT( webanpick::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::witness_schedule_object, webanpick::chain::witness_schedule_index )
