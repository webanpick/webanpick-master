...
namespace webanpick { namespace chain {
   ...
   using webanpick::protocol::weight_type;
...
FC_REFLECT_TYPENAME( webanpick::chain::shared_authority::account_authority_map)
FC_REFLECT( webanpick::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
