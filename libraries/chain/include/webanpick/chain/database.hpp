...
#include <webanpick/chain/hardfork_property_object.hpp>
#include <webanpick/chain/node_property_object.hpp>
#include <webanpick/chain/fork_database.hpp>
#include <webanpick/chain/block_log.hpp>
#include <webanpick/chain/operation_notification.hpp>
#include <webanpick/chain/util/signal.hpp>
...
namespace webanpick { namespace chain {
   ...
   using webanpick::protocol::signed_transaction;
   using webanpick::protocol::operation;
   ...
   class database : public chainbase::database
   {
      public:
         ...
         struct open_args
         {
            ...
            uint64_t initial_supply = WEBANPICK_INIT_SUPPLY;
         ...
         chain_id_type webanpick_chain_id;
          ...
          *
          * Passing slot_num == 0 returns WEBANPICK_NULL_WITNESS
          */
         ...
         /** @return the sbd created and deposited to_account, may return WEBANPICK if there is no median feed */
         std::pair< asset, asset > create_sbd( const account_object& to_account, asset webanpick, bool to_reward_balance=false );
         asset create_vesting( const account_object& to_account, asset webanpick, bool to_reward_balance=false );
          ...
          * WEBANPICK.  Return 0 SBD if there isn't a current_median_history
          */
         asset to_sbd( const asset& webanpick )const;
         asset to_webanpick( const asset& sbd )const;
         ...
         void init_schema();
         void init_genesis(uint64_t initial_supply = WEBANPICK_INIT_SUPPLY );
   ...
   protected:
      ...
      private:
         ...
         fc::time_point_sec            _hardfork_times[ WEBANPICK_NUM_HARDFORKS + 1 ];
         protocol::hardfork_version    _hardfork_versions[ WEBANPICK_NUM_HARDFORKS + 1 ];
