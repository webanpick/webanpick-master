...
#include <webanpick/protocol/authority.hpp>
...
#include <webanpick/chain/shared_authority.hpp>
...
namespace webanpick { namespace chain {
   ...
   using webanpick::protocol::authority;
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = WEBANPICK_NULL_ACCOUNT;
         ...
         bool              can_vote = true;
         uint16_t          voting_power = WEBANPICK_100_PERCENT;   ///< current voting power of this account, it falls after every vote
         time_point_sec    last_vote_time; ///< used to increase the voting power of this account the longer it goes without voting.

         asset             balance = asset( 0, WEBANPICK_SYMBOL );  ///< total liquid shares held by this account
         asset             savings_balance = asset( 0, WEBANPICK_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  WEBANPICK_MIN_COMPOUNDING_INTERVAL_SECONDS has past since sbd_last_interest_payment then
         ...
         asset             reward_webanpick_balance = asset( 0, WEBANPICK_SYMBOL );
         asset             reward_vesting_balance = asset( 0, VESTS_SYMBOL );
         asset             reward_vesting_webanpick = asset( 0, WEBANPICK_SYMBOL );
         ...
         fc::array<share_type, WEBANPICK_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( WEBANPICK_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
FC_REFLECT( webanpick::chain::account_object,
             ...
             (reward_webanpick_balance)(reward_sbd_balance)(reward_vesting_balance)(reward_vesting_webanpick)
...
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::account_object, webanpick::chain::account_index )

FC_REFLECT( webanpick::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::account_authority_object, webanpick::chain::account_authority_index )

FC_REFLECT( webanpick::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::vesting_delegation_object, webanpick::chain::vesting_delegation_index )

FC_REFLECT( webanpick::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::vesting_delegation_expiration_object, webanpick::chain::vesting_delegation_expiration_index )

FC_REFLECT( webanpick::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::owner_authority_history_object, webanpick::chain::owner_authority_history_index )

FC_REFLECT( webanpick::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::account_recovery_request_object, webanpick::chain::account_recovery_request_index )

FC_REFLECT( webanpick::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::change_recovery_account_request_object, webanpick::chain::change_recovery_account_request_index )
