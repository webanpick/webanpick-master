...
FC_REFLECT( webanpick::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( webanpick::chain::block_summary_object, webanpick::chain::block_summary_index )
