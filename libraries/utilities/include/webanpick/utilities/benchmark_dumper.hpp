...
namespace webanpick { namespace utilities {
...
FC_REFLECT( webanpick::utilities::benchmark_dumper::index_memory_details_t,
            (index_name)(index_size)(item_sizeof)(item_additional_allocation)
            (additional_container_allocation)(total_index_mem_usage)
          )

FC_REFLECT( webanpick::utilities::benchmark_dumper::database_object_sizeof_t,
            (object_name)(object_size) )

FC_REFLECT( webanpick::utilities::benchmark_dumper::measurement,
            (block_number)(real_ms)(cpu_ms)(current_mem)(peak_mem)(index_memory_details_cntr) )

FC_REFLECT( webanpick::utilities::benchmark_dumper::TAllData,
