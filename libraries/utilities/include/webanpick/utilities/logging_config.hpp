...
FC_REFLECT( webanpick::utilities::console_appender_args, (appender)(stream) )
FC_REFLECT( webanpick::utilities::file_appender_args, (appender)(file) )
FC_REFLECT( webanpick::utilities::logger_args, (name)(level)(appender) )
