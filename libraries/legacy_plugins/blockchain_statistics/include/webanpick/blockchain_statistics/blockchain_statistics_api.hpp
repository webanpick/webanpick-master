...
#include <webanpick/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const webanpick::app::api_context& ctx );
...
FC_REFLECT( webanpick::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( webanpick::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
