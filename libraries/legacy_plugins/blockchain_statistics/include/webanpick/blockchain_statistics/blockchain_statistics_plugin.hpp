...
// time.
//
#ifndef WEBANPICK_BLOCKCHAIN_STATISTICS_SPACE_ID
#define WEBANPICK_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef WEBANPICK_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define WEBANPICK_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif

namespace webanpick { namespace blockchain_statistics {
...
{
   bucket_object_type = ( WEBANPICK_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public webanpick::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return WEBANPICK_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           webanpick_transferred = 0;                       ///< WEBANPICK transferred from account to account
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of WEBANPICK paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of WEBANPICK into VESTS
   share_type           webanpick_vested = 0;                            ///< Ammount of WEBANPICK vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to WEBANPICK
...
} } // webanpick::blockchain_statistics

FC_REFLECT( webanpick::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( webanpick::blockchain_statistics::bucket_object, webanpick::blockchain_statistics::bucket_index )
