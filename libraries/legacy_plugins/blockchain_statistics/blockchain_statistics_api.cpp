...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( webanpick::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( WEBANPICK_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const webanpick::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->webanpick_transferred                      += b.webanpick_transferred;
   ...
   this->webanpick_vested                           += b.webanpick_vested;
   ...
   this->webanpick_converted                        += b.webanpick_converted;
