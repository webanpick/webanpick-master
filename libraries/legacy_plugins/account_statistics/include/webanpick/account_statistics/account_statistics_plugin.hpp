#include <webanpick/app/plugin.hpp>
...
// time.
//
#ifndef WEBANPICK_ACCOUNT_STATISTICS_SPACE_ID
#define WEBANPICK_ACCOUNT_STATISTICS_SPACE_ID 10
#endif

#ifndef WEBANPICK_ACCOUNT_STATISTICS_PLUGIN_NAME
#define WEBANPICK_ACCOUNT_STATISTICS_PLUGIN_NAME "account_stats"
#endif
...
{
   account_stats_bucket_object_type    = ( WEBANPICK_ACCOUNT_STATISTICS_SPACE_ID << 8 ),
   account_activity_bucket_object_type = ( WEBANPICK_ACCOUNT_STATISTICS_SPACE_ID << 8 ) + 1
};
...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_webanpick_value = 0;     ///< WEBANPICK Value of author rewards
   ...
   share_type           curation_rewards_webanpick_value = 0;         ///< WEBANPICK Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of WEBANPICK paid as liquidity rewards
   ...
   share_type           webanpick_sent = 0;                           ///< WEBANPICK sent from this account
   share_type           webanpick_received = 0;                       ///< WEBANPICK received by this account
   ...
   share_type           webanpick_vested = 0;                         ///< WEBANPICK vested by the account
   ...
   share_type           webanpick_received_from_withdrawls = 0;       ///< WEBANPICK received from this account's vesting withdrawals
   share_type           webanpick_received_from_routes = 0;           ///< WEBANPICK received from another account's vesting withdrawals
   ...
   share_type           webanpick_converted = 0;                      ///< Amount of WEBANPICK that was converted
   ...
   share_type           limit_order_webanpick_paid = 0;               ///< WEBANPICK paid by limit orders
   share_type           limit_order_webanpick_received = 0;           ///< WEBANPICK received from limit orders
...
class account_statistics_plugin : public webanpick::app::plugin
{
   public:
      account_statistics_plugin( application* app );
      virtual ~account_statistics_plugin();

      virtual std::string plugin_name()const override { return WEBANPICK_ACCOUNT_STATISTICS_PLUGIN_NAME; }
...
FC_REFLECT( webanpick::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (webanpick_received_from_withdrawls)
   (webanpick_received_from_routes)
   ...
   (limit_order_webanpick_paid)
   (limit_order_webanpick_received)
   (limit_order_sbd_paid)
   (limit_order_sbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( webanpick::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   webanpick::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
