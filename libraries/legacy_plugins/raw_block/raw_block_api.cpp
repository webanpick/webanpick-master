...
{
   public:
      raw_block_api_impl( webanpick::app::application& _app );

      std::shared_ptr< webanpick::plugin::raw_block::raw_block_plugin > get_plugin();

      webanpick::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( webanpick::app::application& _app ) : app( _app )
{}

std::shared_ptr< webanpick::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const webanpick::app::api_context& ctx )
{
...
get_raw_block_result raw_block_api::get_raw_block( get_raw_block_args args )
{
   ...
   std::shared_ptr< webanpick::chain::database > db = my->app.chain_database();
