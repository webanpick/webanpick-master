...
#include <webanpick/protocol/sign_state.hpp>

#include <webanpick/chain/account_object.hpp>
#include <webanpick/chain/database.hpp>

#include <webanpick/plugins/auth_util/auth_util_api.hpp>
#include <webanpick/plugins/auth_util/auth_util_plugin.hpp>

#include <fc/container/flat.hpp>

namespace webanpick { namespace plugin { namespace auth_util {
...
{
   public:
      auth_util_api_impl( webanpick::app::application& _app );
      void check_authority_signature( const check_authority_signature_params& args, check_authority_signature_result& result );

      std::shared_ptr< webanpick::plugin::auth_util::auth_util_plugin > get_plugin();

      webanpick::app::application& app;
};

auth_util_api_impl::auth_util_api_impl( webanpick::app::application& _app ) : app( _app )
{}

std::shared_ptr< webanpick::plugin::auth_util::auth_util_plugin > auth_util_api_impl::get_plugin()
{
...
auth_util_api::auth_util_api( const webanpick::app::api_context& ctx )
{
