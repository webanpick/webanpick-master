...
struct private_message_operation : public webanpick::protocol::base_operation
{
...
FC_REFLECT( webanpick::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

WEBANPICK_DECLARE_OPERATION_TYPE( webanpick::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( webanpick::private_message::private_message_plugin_operation )
