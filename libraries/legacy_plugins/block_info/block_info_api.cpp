...
#include <webanpick/plugins/block_info/block_info_api.hpp>
#include <webanpick/plugins/block_info/block_info_plugin.hpp>

namespace webanpick { namespace plugin { namespace block_info {
...
{
   public:
      block_info_api_impl( webanpick::app::application& _app );

      std::shared_ptr< webanpick::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( webanpick::app::application& _app ) : app( _app )
{}

std::shared_ptr< webanpick::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const webanpick::app::api_context& ctx )
{
