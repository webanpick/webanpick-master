...
FC_REFLECT( webanpick::plugins::json_rpc::detail::json_rpc_error, (code)(message)(data) )
FC_REFLECT( webanpick::plugins::json_rpc::detail::json_rpc_response, (jsonrpc)(result)(error)(id) )

FC_REFLECT( webanpick::plugins::json_rpc::detail::get_signature_args, (method) )
