...
{
   discussion( const webanpick::chain::comment_object& o, const webanpick::chain::database& db ) :
...
FC_REFLECT( webanpick::plugins::tags::api_tag_object,
            (name)(total_payouts)(net_votes)(top_posts)(comments)(trending) )

FC_REFLECT( webanpick::plugins::tags::vote_state,
            (voter)(weight)(rshares)(percent)(reputation)(time) )

FC_REFLECT_DERIVED( webanpick::plugins::tags::discussion, (webanpick::plugins::database_api::api_comment_object),
...
FC_REFLECT( webanpick::plugins::tags::get_trending_tags_args,
            (start_tag)(limit) )

FC_REFLECT( webanpick::plugins::tags::get_trending_tags_return,
            (tags) )

FC_REFLECT( webanpick::plugins::tags::get_tags_used_by_author_args,
            (author) )

FC_REFLECT( webanpick::plugins::tags::tag_count_object,
            (tag)(count) )

FC_REFLECT( webanpick::plugins::tags::get_tags_used_by_author_return,
            (tags) )

FC_REFLECT( webanpick::plugins::tags::get_discussion_args,
            (author)(permlink) )

FC_REFLECT( webanpick::plugins::tags::discussion_query,
            (tag)(limit)(filter_tags)(select_authors)(select_tags)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink) )

FC_REFLECT( webanpick::plugins::tags::discussion_query_result,
            (discussions) )

FC_REFLECT( webanpick::plugins::tags::get_replies_by_last_update_args,
            (start_parent_author)(start_permlink)(limit) )

FC_REFLECT( webanpick::plugins::tags::get_discussions_by_author_before_date_args,
            (author)(start_permlink)(before_date)(limit) )

FC_REFLECT( webanpick::plugins::tags::get_active_votes_return,
            (votes) )
