...
using webanpick::chain::share_type;
using webanpick::chain::asset;
...
struct get_ticker_return
{
   ...
   asset       webanpick_volume = asset( 0 , WEBANPICK_SYMBOL );
...
FC_REFLECT( webanpick::plugins::market_history::get_ticker_return,
            (latest)(lowest_ask)(highest_bid)(percent_change)(webanpick_volume)(sbd_volume) )

FC_REFLECT( webanpick::plugins::market_history::get_volume_return,
            (webanpick_volume)(sbd_volume) )

FC_REFLECT( webanpick::plugins::market_history::order,
            (order_price)(real_price)(webanpick)(sbd)(created) )

FC_REFLECT( webanpick::plugins::market_history::get_order_book_args,
            (limit) )

FC_REFLECT( webanpick::plugins::market_history::get_order_book_return,
            (bids)(asks) )

FC_REFLECT( webanpick::plugins::market_history::market_trade,
            (date)(current_pays)(open_pays) )

FC_REFLECT( webanpick::plugins::market_history::get_trade_history_args,
            (start)(end)(limit) )

FC_REFLECT( webanpick::plugins::market_history::get_trade_history_return,
            (trades) )

FC_REFLECT( webanpick::plugins::market_history::get_recent_trades_args,
            (limit) )

FC_REFLECT( webanpick::plugins::market_history::get_market_history_args,
            (bucket_seconds)(start)(end) )

FC_REFLECT( webanpick::plugins::market_history::get_market_history_return,
            (buckets) )

FC_REFLECT( webanpick::plugins::market_history::get_market_history_buckets_return,
            (bucket_sizes) )
