...
#define WEBANPICK_MARKET_HISTORY_API_PLUGIN_NAME "market_history_api"
...
public:
   ...
   static const std::string& name() { static std::string name = WEBANPICK_MARKET_HISTORY_API_PLUGIN_NAME; return name; }
