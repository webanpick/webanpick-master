...
struct account_reputation
{
   ...
   webanpick::protocol::share_type reputation;
};
...
FC_REFLECT( webanpick::plugins::follow::feed_entry,
            (author)(permlink)(reblog_by)(reblog_on)(entry_id) );

FC_REFLECT( webanpick::plugins::follow::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) );

FC_REFLECT( webanpick::plugins::follow::blog_entry,
            (author)(permlink)(blog)(reblog_on)(entry_id) );

FC_REFLECT( webanpick::plugins::follow::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) );

FC_REFLECT( webanpick::plugins::follow::account_reputation,
            (account)(reputation) );

FC_REFLECT( webanpick::plugins::follow::api_follow_object,
            (follower)(following)(what) );

FC_REFLECT( webanpick::plugins::follow::reblog_count,
            (author)(count) );

FC_REFLECT( webanpick::plugins::follow::get_followers_args,
            (account)(start)(type)(limit) );

FC_REFLECT( webanpick::plugins::follow::get_followers_return,
            (followers) );

FC_REFLECT( webanpick::plugins::follow::get_following_return,
            (following) );

FC_REFLECT( webanpick::plugins::follow::get_follow_count_args,
            (account) );

FC_REFLECT( webanpick::plugins::follow::get_follow_count_return,
            (account)(follower_count)(following_count) );

FC_REFLECT( webanpick::plugins::follow::get_feed_entries_args,
            (account)(start_entry_id)(limit) );

FC_REFLECT( webanpick::plugins::follow::get_feed_entries_return,
            (feed) );

FC_REFLECT( webanpick::plugins::follow::get_feed_return,
            (feed) );

FC_REFLECT( webanpick::plugins::follow::get_blog_entries_return,
            (blog) );

FC_REFLECT( webanpick::plugins::follow::get_blog_return,
            (blog) );

FC_REFLECT( webanpick::plugins::follow::get_account_reputations_args,
            (account_lower_bound)(limit) );

FC_REFLECT( webanpick::plugins::follow::get_account_reputations_return,
            (reputations) );

FC_REFLECT( webanpick::plugins::follow::get_reblogged_by_args,
            (author)(permlink) );

FC_REFLECT( webanpick::plugins::follow::get_reblogged_by_return,
            (accounts) );

FC_REFLECT( webanpick::plugins::follow::get_blog_authors_args,
            (blog_account) );

FC_REFLECT( webanpick::plugins::follow::get_blog_authors_return,
            (blog_authors) );
