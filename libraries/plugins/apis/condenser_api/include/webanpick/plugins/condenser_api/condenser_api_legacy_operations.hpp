...
#include <webanpick/plugins/condenser_api/condenser_api_legacy_asset.hpp>
...
namespace webanpick { namespace plugins { namespace condenser_api {
   ...
   struct legacy_comment_options_operation
   {
      ...
      operator comment_options_operation()const
      {
         ...
         op.percent_webanpick_dollars = percent_webanpick_dollars;
      ...
      uint16_t          percent_webanpick_dollars;
      bool              allow_votes;
   ...
   struct legacy_escrow_transfer_operation
   {
      ...
      legacy_escrow_transfer_operation( const escrow_transfer_operation& op ) :
         ...
         webanpick_amount( legacy_asset::from_asset( op.webanpick_amount ) ),
         fee( legacy_asset::from_asset( op.fee ) ),
      ...
      operator escrow_transfer_operation()const
      {
         ...
         op.webanpick_amount = webanpick_amount;
         op.fee = fee;
   ...
   struct legacy_claim_reward_balance_operation
   {
      ...
      legacy_claim_reward_balance_operation( const claim_reward_balance_operation& op ) :
         account( op.account ),
         reward_webanpick( legacy_asset::from_asset( op.reward_webanpick ) ),
      ...
      operator claim_reward_balance_operation()const
      {
         ...
         op.account = account;
         op.reward_webanpick = reward_webanpick;
   ...
   struct legacy_author_reward_operation
   {
      ...
      legacy_author_reward_operation( const author_reward_operation& op ) :
         ...
         webanpick_payout( legacy_asset::from_asset( op.webanpick_payout ) ),
      ...
      operator author_reward_operation()const
      {
         ...
         op.webanpick_payout = webanpick_payout;
...
void to_variant( const webanpick::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, webanpick::plugins::condenser_api::legacy_operation& );

}

FC_REFLECT( webanpick::plugins::condenser_api::legacy_price, (base)(quote) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( webanpick::plugins::condenser_api::legacy_account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( webanpick::plugins::condenser_api::legacy_account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( webanpick::plugins::condenser_api::legacy_transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_webanpick_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(sbd_amount)(webanpick_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( webanpick::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(webanpick_amount) );
FC_REFLECT( webanpick::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_webanpick)(reward_sbd)(reward_vests) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
FC_REFLECT( webanpick::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(sbd_payout)(webanpick_payout)(vesting_payout) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( webanpick::plugins::condenser_api::legacy_producer_reward_operation, (producer)(vesting_shares) )

FC_REFLECT_TYPENAME( webanpick::plugins::condenser_api::legacy_operation )
