...
#include <webanpick/plugins/database_api/database_api.hpp>
#include <webanpick/plugins/block_api/block_api.hpp>
#include <webanpick/plugins/account_history_api/account_history_api.hpp>
#include <webanpick/plugins/account_by_key_api/account_by_key_api.hpp>
#include <webanpick/plugins/network_broadcast_api/network_broadcast_api.hpp>
#include <webanpick/plugins/tags_api/tags_api.hpp>
#include <webanpick/plugins/follow_api/follow_api.hpp>
#include <webanpick/plugins/market_history_api/market_history_api.hpp>
#include <webanpick/plugins/witness_api/witness_api.hpp>

#include <webanpick/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      reward_webanpick_balance( legacy_asset::from_asset( a.reward_webanpick_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_webanpick( legacy_asset::from_asset( a.reward_vesting_webanpick ) ),
   ...
   legacy_asset      reward_webanpick_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_webanpick;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             vesting_balance;  /// convert vesting_shares to vesting webanpick
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      total_vesting_fund_webanpick( legacy_asset::from_asset( o.total_vesting_fund_webanpick ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_webanpick( legacy_asset::from_asset( o.total_reward_fund_webanpick ) ),
      ...
      pending_rewarded_vesting_webanpick( legacy_asset::from_asset( o.pending_rewarded_vesting_webanpick ) ),
   ...
   legacy_asset      total_vesting_fund_webanpick;
   legacy_asset      total_vesting_shares;
   legacy_asset      total_reward_fund_webanpick;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_vesting_shares;
   legacy_asset      pending_rewarded_vesting_webanpick;

   uint16_t          sbd_interest_rate = 0;
   uint16_t          sbd_print_rate = WEBANPICK_100_PERCENT;
   ...
   uint32_t          vote_power_reserve_rate = WEBANPICK_INITIAL_VOTE_POWER_RATE;
...
struct api_witness_object
{
   ...
   time_point_sec          hardfork_time_vote = WEBANPICK_GENESIS_TIME;
};
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = WEBANPICK_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = WEBANPICK_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = WEBANPICK_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = WEBANPICK_HARDFORK_REQUIRED_WITNESSES;
};
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      webanpick_balance( legacy_asset::from_asset( e.webanpick_balance ) ),
   ...
   legacy_asset      sbd_balance;
   legacy_asset      webanpick_balance;
...
struct discussion
{
   ...
   discussion( const tags::discussion& d ) :
      ...
      percent_webanpick_dollars( d.percent_webanpick_dollars ),
   ...
   uint16_t          percent_webanpick_dollars = 0;
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), webanpick_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string webanpick_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      webanpick_volume( legacy_asset::from_asset( t.webanpick_volume ) ),
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      webanpick_volume( legacy_asset::from_asset( v.webanpick_volume ) ),
...
FC_REFLECT( webanpick::plugins::condenser_api::discussion_index,
...
FC_REFLECT( webanpick::plugins::condenser_api::api_account_object,
             ...
             (reward_sbd_balance)(reward_webanpick_balance)(reward_vesting_balance)(reward_vesting_webanpick)
...
FC_REFLECT_DERIVED( webanpick::plugins::condenser_api::extended_account, (webanpick::plugins::condenser_api::api_account_object),
...
FC_REFLECT( webanpick::plugins::condenser_api::extended_dynamic_global_properties,
            ...
            (total_vesting_fund_webanpick)(total_vesting_shares)
            (total_reward_fund_webanpick)(total_reward_shares2)(pending_rewarded_vesting_shares)(pending_rewarded_vesting_webanpick)
...
FC_REFLECT( webanpick::plugins::condenser_api::legacy_chain_properties,
            (account_creation_fee)(maximum_block_size)(sbd_interest_rate)
          )

FC_REFLECT( webanpick::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( webanpick::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( webanpick::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( webanpick::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( webanpick::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (sbd_balance)(webanpick_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( webanpick::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( webanpick::plugins::condenser_api::api_vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT( webanpick::plugins::condenser_api::api_vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( webanpick::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT( webanpick::plugins::condenser_api::discussion,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_webanpick_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
...
FC_REFLECT( webanpick::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( webanpick::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( webanpick::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( webanpick::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( webanpick::plugins::condenser_api::get_version_return,
            (blockchain_version)(webanpick_revision)(fc_revision) )

FC_REFLECT( webanpick::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(webanpick_volume)(sbd_volume) )

FC_REFLECT( webanpick::plugins::condenser_api::volume,
            (webanpick_volume)(sbd_volume) )

FC_REFLECT( webanpick::plugins::condenser_api::order,
            (order_price)(real_price)(webanpick)(sbd)(created) )

FC_REFLECT( webanpick::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( webanpick::plugins::condenser_api::market_trade,
