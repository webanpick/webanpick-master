#include <webanpick/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <webanpick/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > WEBANPICK_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( WEBANPICK_DEBUG_NODE_API_PLUGIN_NAME );
}
