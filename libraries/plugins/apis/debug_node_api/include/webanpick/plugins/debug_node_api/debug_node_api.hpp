...
namespace webanpick { namespace plugins { namespace debug_node {
...
} } } // webanpick::plugins::debug_node

FC_REFLECT( webanpick::plugins::debug_node::debug_push_blocks_args,
            (src_filename)(count)(skip_validate_invariants) )

FC_REFLECT( webanpick::plugins::debug_node::debug_push_blocks_return,
            (blocks) )

FC_REFLECT( webanpick::plugins::debug_node::debug_generate_blocks_until_args,
            (debug_key)(head_block_time)(generate_sparsely) )

FC_REFLECT( webanpick::plugins::debug_node::debug_pop_block_return,
            (block) )

FC_REFLECT( webanpick::plugins::debug_node::debug_set_hardfork_args,
            (hardfork_id) )

FC_REFLECT( webanpick::plugins::debug_node::debug_has_hardfork_return,
            (has_hardfork) )

FC_REFLECT( webanpick::plugins::debug_node::debug_get_json_schema_return,
            (schema) )
