...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_webanpick_dollars( o.percent_webanpick_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      reward_webanpick_balance( a.reward_webanpick_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_webanpick( a.reward_vesting_webanpick ),
   ...
   asset             reward_webanpick_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_webanpick;
...
{
   price                order_price;
   double               real_price; // dollars per webanpick
...
} } } // webanpick::plugins::database_api

FC_REFLECT( webanpick::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( webanpick::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( webanpick::plugins::database_api::api_account_object,
...
FC_REFLECT( webanpick::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( webanpick::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( webanpick::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( webanpick::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( webanpick::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( webanpick::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( webanpick::plugins::database_api::api_signed_block_object, (webanpick::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( webanpick::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( webanpick::plugins::database_api::order, (order_price)(real_price)(webanpick)(sbd)(created) );

FC_REFLECT( webanpick::plugins::database_api::order_book, (asks)(bids) );
