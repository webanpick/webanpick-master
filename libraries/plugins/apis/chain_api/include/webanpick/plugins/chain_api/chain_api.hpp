...
{
   webanpick::chain::signed_block block;
...
typedef webanpick::chain::signed_transaction push_transaction_args;
...
FC_REFLECT( webanpick::plugins::chain::push_block_args, (block)(currently_syncing) )
FC_REFLECT( webanpick::plugins::chain::push_block_return, (success)(error) )
FC_REFLECT( webanpick::plugins::chain::push_transaction_return, (success)(error) )
