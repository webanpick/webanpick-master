#include <webanpick/plugins/chain_api/chain_api_plugin.hpp>
#include <webanpick/plugins/chain_api/chain_api.hpp>
...
{
   JSON_RPC_REGISTER_API( WEBANPICK_CHAIN_API_PLUGIN_NAME );
}
