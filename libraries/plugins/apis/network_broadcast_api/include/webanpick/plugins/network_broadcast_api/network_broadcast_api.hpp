#pragma once
#include <webanpick/protocol/block.hpp>
...
using fc::variant;
using fc::optional;
using webanpick::plugins::json_rpc::void_type;
...
FC_REFLECT( webanpick::plugins::network_broadcast_api::broadcast_transaction_args,
   (trx)(max_block_age) )

FC_REFLECT( webanpick::plugins::network_broadcast_api::broadcast_block_args,
   (block) )

FC_REFLECT( webanpick::plugins::network_broadcast_api::broadcast_transaction_synchronous_return,
