...
{
   public:
      account_history_api_impl() : _db( appbase::app().get_plugin< webanpick::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( WEBANPICK_ACCOUNT_HISTORY_API_PLUGIN_NAME );
}
