...
#define WEBANPICK_ACCOUNT_HISTORY_PLUGIN_NAME "account_history"
...
// time.
//
#ifndef WEBANPICK_ACCOUNT_HISTORY_SPACE_ID
#define WEBANPICK_ACCOUNT_HISTORY_SPACE_ID 5
#endif
...
class account_history_plugin : public plugin< account_history_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WEBANPICK_ACCOUNT_HISTORY_PLUGIN_NAME; return name; }
