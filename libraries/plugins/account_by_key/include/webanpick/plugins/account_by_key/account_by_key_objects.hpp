...
#ifndef WEBANPICK_ACCOUNT_BY_KEY_SPACE_ID
#define WEBANPICK_ACCOUNT_BY_KEY_SPACE_ID 11
#endif

enum account_by_key_object_types
{
   key_lookup_object_type = ( WEBANPICK_ACCOUNT_BY_KEY_SPACE_ID << 8 )
};
...
FC_REFLECT( webanpick::plugins::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::account_by_key::key_lookup_object, webanpick::plugins::account_by_key::key_lookup_index )
