...
#ifndef WEBANPICK_SMT_TEST_SPACE_ID
#define WEBANPICK_SMT_TEST_SPACE_ID 13
#endif

enum smt_test_object_types
{
   smt_token_object_type = ( WEBANPICK_SMT_TEST_SPACE_ID << 8 )
};
...
FC_REFLECT( webanpick::plugins::smt_test::smt_token_object,
   (id)
   (control_account)
   (decimal_places)
   (max_supply)
...
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::smt_test::smt_token_object, webanpick::plugins::smt_test::smt_token_index )
