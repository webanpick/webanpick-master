...
namespace webanpick { namespace plugins { namespace block_log_info {

using namespace std;
using namespace webanpick::chain;

#ifndef WEBANPICK_BLOCK_LOG_INFO_SPACE_ID
#define WEBANPICK_BLOCK_LOG_INFO_SPACE_ID 14
#endif

enum block_log_info_object_types
{
   block_log_hash_state_object_type      = ( WEBANPICK_BLOCK_LOG_INFO_SPACE_ID << 8 )    ,
   block_log_pending_message_object_type = ( WEBANPICK_BLOCK_LOG_INFO_SPACE_ID << 8 ) + 1,
};
...
} } } // webanpick::plugins::block_log_info


FC_REFLECT( webanpick::plugins::block_log_info::block_log_hash_state_object, (id)(total_size)(rsha256)(last_interval) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::block_log_info::block_log_hash_state_object, webanpick::plugins::block_log_info::block_log_hash_state_index )

FC_REFLECT( webanpick::plugins::block_log_info::block_log_message_data, (block_num)(total_size)(current_interval)(rsha256) )

FC_REFLECT( webanpick::plugins::block_log_info::block_log_pending_message_object, (id)(data) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::block_log_info::block_log_pending_message_object, webanpick::plugins::block_log_info::block_log_pending_message_index )
