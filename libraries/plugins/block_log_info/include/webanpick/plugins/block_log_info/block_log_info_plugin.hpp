...
#define WEBANPICK_BLOCK_LOG_INFO_PLUGIN_NAME "block_log_info"
...
class block_log_info_plugin : public appbase::plugin< block_log_info_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WEBANPICK_BLOCK_LOG_INFO_PLUGIN_NAME; return name; }
