...
// time.
//
#ifndef WEBANPICK_TAG_SPACE_ID
#define WEBANPICK_TAG_SPACE_ID 5
#endif

#define WEBANPICK_TAGS_PLUGIN_NAME "tags"
...
enum
{
   tag_object_type              = ( WEBANPICK_TAG_SPACE_ID << 8 ),
   tag_stats_object_type        = ( WEBANPICK_TAG_SPACE_ID << 8 ) + 1,
   peer_stats_object_type       = ( WEBANPICK_TAG_SPACE_ID << 8 ) + 2,
   author_tag_stats_object_type = ( WEBANPICK_TAG_SPACE_ID << 8 ) + 3
};
...
class tags_plugin : public plugin< tags_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WEBANPICK_TAGS_PLUGIN_NAME; return name; }
...
FC_REFLECT( webanpick::plugins::tags::tag_object,
   (id)(tag)(created)(active)(cashout)(net_rshares)(net_votes)(hot)(trending)(promoted_balance)(children)(author)(parent)(comment) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::tags::tag_object, webanpick::plugins::tags::tag_index )

FC_REFLECT( webanpick::plugins::tags::tag_stats_object,
   (id)(tag)(total_payout)(net_votes)(top_posts)(comments)(total_trending) );
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::tags::tag_stats_object, webanpick::plugins::tags::tag_stats_index )

FC_REFLECT( webanpick::plugins::tags::comment_metadata, (tags) );

FC_REFLECT( webanpick::plugins::tags::author_tag_stats_object, (id)(author)(tag)(total_posts)(total_rewards) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::tags::author_tag_stats_object, webanpick::plugins::tags::author_tag_stats_index )
