...
#ifndef WEBANPICK_WITNESS_SPACE_ID
#define WEBANPICK_WITNESS_SPACE_ID 12
#endif

enum witness_plugin_object_type
{
   account_bandwidth_object_type = ( WEBANPICK_WITNESS_SPACE_ID << 8 ),
   content_edit_lock_object_type = ( WEBANPICK_WITNESS_SPACE_ID << 8 ) + 1,
   reserve_ratio_object_type     = ( WEBANPICK_WITNESS_SPACE_ID << 8 ) + 2,
};
...
class reserve_ratio_object : public object< reserve_ratio_object_type, reserve_ratio_object >
{
   public:
       ...
       *   reaches WEBANPICK_MAX_RESERVE_RATIO.  Any time average_block_size is greater than
       ...
       *
       *    max_bandwidth = maximum_block_size * WEBANPICK_BANDWIDTH_AVERAGE_WINDOW_SECONDS / WEBANPICK_BLOCK_INTERVAL
       *
...
FC_REFLECT_ENUM( webanpick::plugins::witness::bandwidth_type, (post)(forum)(market) )

FC_REFLECT( webanpick::plugins::witness::account_bandwidth_object,
            (id)(account)(type)(average_bandwidth)(lifetime_bandwidth)(last_bandwidth_update) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::witness::account_bandwidth_object, webanpick::plugins::witness::account_bandwidth_index )

FC_REFLECT( webanpick::plugins::witness::reserve_ratio_object,
            (id)(average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::witness::reserve_ratio_object, webanpick::plugins::witness::reserve_ratio_index )
