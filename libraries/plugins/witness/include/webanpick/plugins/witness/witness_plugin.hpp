...
#define WEBANPICK_WITNESS_PLUGIN_NAME "witness"
...
{
public:
   APPBASE_PLUGIN_REQUIRES((webanpick::plugins::chain::chain_plugin)(webanpick::plugins::p2p::p2p_plugin))

   witness_plugin();
   virtual ~witness_plugin();

   static const std::string& name() { static std::string name = WEBANPICK_WITNESS_PLUGIN_NAME; return name; }
