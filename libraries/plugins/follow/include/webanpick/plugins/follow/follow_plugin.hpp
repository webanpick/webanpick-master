...
#define WEBANPICK_FOLLOW_PLUGIN_NAME "follow"
...
using webanpick::chain::generic_custom_operation_interpreter;
...
class follow_plugin : public appbase::plugin< follow_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WEBANPICK_FOLLOW_PLUGIN_NAME; return name; }
