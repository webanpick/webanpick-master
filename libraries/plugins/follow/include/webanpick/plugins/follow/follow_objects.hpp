...
#ifndef WEBANPICK_FOLLOW_SPACE_ID
#define WEBANPICK_FOLLOW_SPACE_ID 8
#endif

enum follow_plugin_object_type
{
   follow_object_type            = ( WEBANPICK_FOLLOW_SPACE_ID << 8 ),
   feed_object_type              = ( WEBANPICK_FOLLOW_SPACE_ID << 8 ) + 1,
   reputation_object_type        = ( WEBANPICK_FOLLOW_SPACE_ID << 8 ) + 2,
   blog_object_type              = ( WEBANPICK_FOLLOW_SPACE_ID << 8 ) + 3,
   follow_count_object_type      = ( WEBANPICK_FOLLOW_SPACE_ID << 8 ) + 4,
   blog_author_stats_object_type = ( WEBANPICK_FOLLOW_SPACE_ID << 8 ) + 5
};
...
/**
 *  This index is maintained to get an idea of which authors are rewebanpicked by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were rewebanpicked by this blog
 */
...
FC_REFLECT_ENUM( webanpick::plugins::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( webanpick::plugins::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::follow::follow_object, webanpick::plugins::follow::follow_index )

FC_REFLECT( webanpick::plugins::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::follow::feed_object, webanpick::plugins::follow::feed_index )

FC_REFLECT( webanpick::plugins::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::follow::blog_object, webanpick::plugins::follow::blog_index )

FC_REFLECT( webanpick::plugins::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::follow::reputation_object, webanpick::plugins::follow::reputation_index )

FC_REFLECT( webanpick::plugins::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::follow::follow_count_object, webanpick::plugins::follow::follow_count_index )

FC_REFLECT( webanpick::plugins::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( webanpick::plugins::follow::blog_author_stats_object, webanpick::plugins::follow::blog_author_stats_index );

namespace helpers
{
   template <>
   class index_statistic_provider<webanpick::plugins::follow::feed_index>
   {
   public:
      typedef webanpick::plugins::follow::feed_index IndexType;
      typedef typename webanpick::plugins::follow::feed_object::t_reblogged_by_container t_reblogged_by_container;
