...
namespace webanpick { namespace plugins { namespace p2p {
...
using webanpick::protocol::block_header;
using webanpick::protocol::signed_block_header;
using webanpick::protocol::signed_block;
using webanpick::protocol::block_id_type;
...
public:
   ...
   virtual webanpick::protocol::chain_id_type get_chain_id() const override;
...
webanpick::protocol::chain_id_type p2p_plugin_impl::get_chain_id() const
{
...
void p2p_plugin::plugin_initialize(const boost::program_options::variables_map& options)
{
   ...
   my->user_agent = "Webanpick Reference Implementation";
...
void p2p_plugin::broadcast_block( const webanpick::protocol::signed_block& block )
{
   ulog("Broadcasting block #${n}", ("n", block.block_num()));
   my->node->broadcast( graphene::net::block_message( block ) );
}

void p2p_plugin::broadcast_transaction( const webanpick::protocol::signed_transaction& tx )
{
...
} } } // namespace webanpick::plugins::p2p
