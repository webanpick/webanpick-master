...
#define WEBANPICK_P2P_PLUGIN_NAME "p2p"
...
public:
   ...
   static const std::string& name() { static std::string name = WEBANPICK_P2P_PLUGIN_NAME; return name; }

   virtual void plugin_initialize(const bpo::variables_map& options) override;
   virtual void plugin_startup() override;
   virtual void plugin_shutdown() override;

   void broadcast_block( const webanpick::protocol::signed_block& block );
   void broadcast_transaction( const webanpick::protocol::signed_transaction& tx );
