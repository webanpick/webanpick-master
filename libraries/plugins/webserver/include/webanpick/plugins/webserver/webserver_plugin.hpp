...
#define WEBANPICK_WEBSERVER_PLUGIN_NAME "webserver"

namespace webanpick { namespace plugins { namespace webserver {
...
class webserver_plugin : public appbase::plugin< webserver_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = WEBANPICK_WEBSERVER_PLUGIN_NAME; return name; }
