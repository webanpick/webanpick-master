...
#define WEBANPICK_EXAMPLE_API_PLUGIN_NAME "example_api"

namespace webanpick { namespace example_api_plugin {
   ...
   class example_api_plugin : public appbase::plugin< example_api_plugin >
   {
      public:
         ...
         static const std::string& name() { static std::string name = WEBANPICK_EXAMPLE_API_PLUGIN_NAME; return name; }
...
} } // webanpick::example_api_plugin

// Args and return types need to be reflected. hello_world_args does not because it is a typedef of a reflected type
FC_REFLECT( webanpick::example_api_plugin::hello_world_return, (message) )
FC_REFLECT( webanpick::example_api_plugin::echo_args, (call) )
FC_REFLECT( webanpick::example_api_plugin::echo_return, (response) )
