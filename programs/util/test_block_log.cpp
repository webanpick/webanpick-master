...
int main( int argc, char** argv, char** envp )
{
   try
   {
      //webanpick::chain::database db;
      webanpick::chain::block_log log;
      ...
      webanpick::protocol::signed_block b1;
      b1.witness = "alice";
      b1.previous = webanpick::protocol::block_id_type();
      ...
      webanpick::protocol::signed_block b2;
      b2.witness = "bob";
      b2.previous = b1.id();
